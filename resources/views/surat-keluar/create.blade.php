        ...
        <div class="col-lg-10 mx-auto">
            <div class="card">
                <div class="card-header bg-success text-white">
                    <h5 class="mb-0">
                        <i class="bi bi-plus-circle"></i> Form Tambah Surat Keluar
                    </h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('surat-keluar.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                @enderror
                                <small class="text-muted">Format: XXX/SK-TU/YYYY</small>
                            </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <strong>Catatan:</strong> Surat yang dibuat akan berstatus <strong>Draft</strong>. 
                            Setelah disimpan, Pimpinan dapat melakukan Approve.
                        </div>
